...
from postmodel.aggregation import Aggregate
from postmodel.asyncdb.base.client import BaseDBAsyncClient
from postmodel.exceptions import DoesNotExist, FieldError, IntegrityError, MultipleObjectsReturned
from postmodel.query_utils import Prefetch, Q, QueryModifier, _get_joins_for_related_field
from postmodel.utils import QueryAsyncIterator
...
class QuerySet(AwaitableQuery):
    ...
    def annotate(self, **kwargs) -> "QuerySet":
        ...
        for key, aggregation in kwargs.items():
            ...
            from postmodel.models import get_filters_for_field
