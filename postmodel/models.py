...
from postmodel.asyncdb.base.client import BaseDBAsyncClient  # noqa
from postmodel.exceptions import ConfigurationError, OperationalError
from postmodel.fields import (
    Field,
    ManyToManyField,
    ManyToManyRelationManager,
    RelationQueryContainer,
)
from postmodel.filters import get_filters_for_field
from postmodel.queryset import QuerySet
...
class MetaInfo:
    ...
    def db(self) -> BaseDBAsyncClient:
        ...
        try:
            return Postmodel.get_connection(self.default_connection).get_current_transaction()
        except KeyError:
